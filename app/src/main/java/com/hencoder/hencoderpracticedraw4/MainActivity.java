...
public class MainActivity extends AppCompatActivity {
...

  {
    ...
    pageModels.add(new PageModel(R.layout.sample_set_poly_to_poly, R.string.title_set_poly_to_poly,
        R.layout.sample_set_poly_to_poly));
    pageModels.add(
        new PageModel(R.layout.sample_reverse_coordinate, R.string.title_reverse_coordinate,
            R.layout.prcatice_reverse_coordinate));
    ...
    pageModels.add(new PageModel(R.layout.sample_flipboard, R.string.title_flip_board,
